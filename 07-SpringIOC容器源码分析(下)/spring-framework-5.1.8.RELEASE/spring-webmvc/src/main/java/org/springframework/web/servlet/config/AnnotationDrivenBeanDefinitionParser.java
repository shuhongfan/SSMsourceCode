...
class AnnotationDrivenBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext context) {
		...
		//创建一个RequestMappingHandlerMapping的bean定义
		...
		//将RequestMappingHandlerMapping的bean定义注册到bean定义的beanDefinitionMap中
		readerContext.getRegistry().registerBeanDefinition(HANDLER_MAPPING_BEAN_NAME, handlerMappingDef);

		//底层注册跨域相关的bean的定义，@CrossOrigin
		...
		//创建ConfigurableWebBindingInitializer的bean的定义
		...
		//创建RequestMappingHandlerAdapter的bean的定义
		...
		//补充注册一些bean的定义，以确保spring容器bean的定义齐全
	...
	private RuntimeBeanReference getContentNegotiationManager(
		...
		if (element.hasAttribute("content-negotiation-manager")) {
			...
			//创建ContentNegotiationManagerFactoryBean的bean定义
			...
			//注册ContentNegotiationManagerFactoryBean的bean的定义
