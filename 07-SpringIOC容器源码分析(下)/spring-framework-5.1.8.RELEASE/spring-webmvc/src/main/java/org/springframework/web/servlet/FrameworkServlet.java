...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
	...
	/**
	 * TODO 得到默认的 dispatcher-servlet.xml
	...
	/**
	 * Servlet初始化，创建servlet的WebApplicationContext
	 * <p>
	...
	protected final void initServletBean() throws ServletException {
		...
		try {
			//TODO 初始化WebApplicationContext容器
			this.webApplicationContext = initWebApplicationContext();

			//spring框架默认什么也没有做，可以自己扩展spring mvc框架
	...
	protected WebApplicationContext initWebApplicationContext() {
		...
		if (wac == null) {
			...
			// TODO 没有在servlet定义WebApplicationContext-->创建一个WebApplicationContext对象
	...
	protected WebApplicationContext findWebApplicationContext() {
		...
		//有属性名，从servletContext上下文获取WebApplicationContext容器对象
	...
	protected WebApplicationContext createWebApplicationContext(@Nullable ApplicationContext parent) {
		...
		//给XmlWebApplicationContext容器对象设置父容器对象
		...
		//TODO 配置和刷新XmlWebApplicationContext容器
		configureAndRefreshWebApplicationContext(wac);

		//返回XmlWebApplicationContext对象
		return wac;
	}
	...
	protected void configureAndRefreshWebApplicationContext(ConfigurableWebApplicationContext wac) {
		...
		if (ObjectUtils.identityToString(wac).equals(wac.getId())) {
			...
			if (this.contextId != null) {
				...
				//给XmlWebApplicationContext设置一个id
				// Generate default id...
		...
		//给XmlWebApplicationContext设置Servletontext
		wac.setServletContext(getServletContext());

		//给XmlWebApplicationContext设置ServletConfig
		wac.setServletConfig(getServletConfig());

		//给XmlWebApplicationContext设置Namespace，也就是名字
		...
		//spring容器默认没有实现该方法，什么也不做
		postProcessWebApplicationContext(wac);

		//应用初始化器
		applyInitializers(wac);

		//TODO 调用XmlWebApplicationContext的refresh()创建spring容器
		wac.refresh();
	}
	...
	protected final void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		//获取之前的ThreadLocal中放置的信息，一个与语言有关的上下文
		LocaleContext previousLocaleContext = LocaleContextHolder.getLocaleContext();

		//创建SimpleLocaleContext，语言相关的上下文
