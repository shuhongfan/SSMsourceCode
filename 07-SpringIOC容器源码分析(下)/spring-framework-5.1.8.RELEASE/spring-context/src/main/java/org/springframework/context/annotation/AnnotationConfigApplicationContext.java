...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	/**
	 * 根据一个或多个注解类创建一个新的spring注解版的容器对象：AnnotationConfigApplicationContext
	 * <p>
	...
	public AnnotationConfigApplicationContext(String... basePackages) {
		//1.初始化bean读取器和扫描器；调用父类GenericApplicationContext无参构造函数，初始化一个BeanFactory
		this();

		//2、扫描包，将包下面的类注册为一个BeanDefinition
		scan(basePackages);
